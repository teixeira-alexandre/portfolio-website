...
const TAB_DATA = [
    ...
    },
    {
        ...
        content: (
            <ul className="list-disc pl-2">
                <li>The Odin Project Fundations</li>
      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            ...
            working with JavaScript, TypeScript, React, Next.js, Node.js, HTML,
            CSS and Git. I&apos;m a nice guy who likes to play videogames, watch
            anime, and learn new skills. I&apos;m excited to work with other to
